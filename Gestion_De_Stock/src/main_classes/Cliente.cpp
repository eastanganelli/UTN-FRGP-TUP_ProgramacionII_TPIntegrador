...
bool Cliente::operator==(Cliente& cliente) {
    return string(this->DNI).find(cliente.DNI) != string::npos && string(this->cuilCuit).find(cliente.cuilCuit) != string::npos
        && string(this->apellido).find(cliente.apellido) != string::npos && string(this->nombre).find(cliente.nombre) != string::npos
        && string(this->correo).find(cliente.correo) != string::npos && string(this->direccion).find(cliente.direccion) != string::npos
        && string(this->celular).find(cliente.celular) != string::npos && string(this->telefono).find(cliente.telefono) != string::npos
